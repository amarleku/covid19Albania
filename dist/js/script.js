...
request.send(), (request = new XMLHttpRequest).open("GET", "https://coronavirus-19-api.herokuapp.com/all", !0), request.onload = function () {
  var e = JSON.parse(this.response);
  document.getElementById("allCases").innerHTML = e.cases, document.getElementById("allRecovered").innerHTML = e.recovered, document.getElementById("allDeaths").innerHTML = e.deaths
}, request.send();